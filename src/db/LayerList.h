...
public:
    ...
    // 1. for pin taps
    BoxOnLayer getMetalRectForbidRegion(const BoxOnLayer& metalRect, bool aggressive) const;
    ...
    utils::IntervalT<int> rangeSearchTrack(int layerIdx, const utils::IntervalT<DBU>& locRange, bool includeBound = true) const;
    utils::IntervalT<int> rangeSearchCrossPoint(int layerIdx, const utils::IntervalT<DBU>& locRange, bool includeBound = true) const;
    ...
    int getLayerNum() const { return layers.size(); }
